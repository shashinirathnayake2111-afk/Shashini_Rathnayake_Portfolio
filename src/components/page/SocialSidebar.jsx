...
const SocialSidebar = ({ isLoaded, isVisible = true }) => {
  ...
  return (
    ...
    >
      ...
      <a href="https://github.com/shashinirathnayake2111-afk" className="social-link" aria-label="GitHub">
        <svg viewBox="0 0 24 24">
      ...
      <a href="mailto:shashinirathnayake2111@gmail.com" className="social-link" aria-label="Email">
        <svg viewBox="0 0 24 24">
